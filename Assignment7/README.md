...
-**According to the dropped frame detector, there were 5 frames dropped overall. This means that I will keep the frame-based timing in this experiment.**
```
#=====================
#IMPORT MODULES
#=====================
